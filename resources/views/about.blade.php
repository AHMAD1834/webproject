  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3">
        <div class="container"><a href="#" class="navbar-brand d-flex align-items-center"> <i
                    class="fa fa-snowflake-o fa-lg text-primary mr-2"></i><strong>SPORTS ACCESSORIES MANAGEMENT
                    SYSTEM</strong></a>
        ...
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-muted mb-0">sports accessories management system have a lots
                        of beneifits like maintain the records
                        of all accessories like bats ,balls,footballs , rackets , tennis balls , tenis ball, and
                        manymore. you can
                        easily add an accessory or you can easily delete the product or update the product and due to
                        this
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">OUR TEAM MANAGES THIS SYSTEM</h2>
                    <p class="font-italic text-muted mb-4">Team manages the all the records of the this management
                        system and take records of all products.</p><a href="#"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">OUR TEAM MANTAIN THIS SYSTEM</h2>
                    <p class="font-italic text-muted mb-4">Our team checks the system and solves any error if system is
                        generating any error.</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn
                        More</a>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            <div class="row mb-4">
                <div class="col-lg-5">
                    ...
                    <p class="font-italic text-muted">This team is highly skillfull and responsible.</p>
                </div>
            </div>
            ...
            <div class="row text-center">
                ...
                <div class="col-xl-5 col-sm-6 mb-5">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                        ...
                        <h5 class="mb-0">M. AHMAD</h5><span class="small text-uppercase text-muted">CEO -
                            Founder</span>
                ...
                <div class="col-xl-5 col-sm-6 mb-4">
                    <div class="bg-white rounded shadow-sm py-5 px-4"><img
                            ...
                            class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                        <h5 class="mb-0">MOIN ALI</h5><span class="small text-uppercase text-muted">CO -
                            Founder</span>
    ...
    <footer class="bg-light pb-5">
        <div class="container text-center">
            <p class="font-italic text-muted mb-0">&copy; Copyrights AHMAD and All rights reserved.</p>
        </div>
    </footer>
</body>
